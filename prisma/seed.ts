  ...
  if (aQueryCount === 0) {
    ...
    const q1 = await db.query.create({
      data: {
        ...
        descriptionText:
          "A wall-mounted planter shaped like a crescent moon, matte finish, holds one small succulent.",
        dimensions: "20cm x 15cm x 8cm",
        materialPreference: "Matte PLA, white",
        useCase: "Indoor decorative wall planter",
        status: "booked",
        matchThreshold: 80,
